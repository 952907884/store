...
<head>
    ...
    <script src="/store/js/index.js" type="text/javascript"></script>
    ...
    <script src="js/clothingband.js" type="text/javascript"></script>
    <script src="js/color.js" type="text/javascript"></script>
...
<div class="am-cf admin-main">
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <div class="sideMenu">
            ...
            <ul>
                ...
                <li>商品分类</li>
                    <li><a href="#" id="Category">商品大类</a></li>
                    <li><a href="#" id="Subclass">商品小类</a></li>
                    <li><a href="#" id="Color">商品颜色</a></li>
                    <li><a href="#" id="Size">商品尺码</a></li>
                    <li><a href="#" id="Clothingband">商品波段</a></li>
                    <li><a href="#" id="Series">商品系列</a></li>
                    <li><a href="#" id="Theme">商品主题</a></li>
                <li>用户评论</li>
                <li>商品回收站</li>
                <li>库存管理 </li>
            </ul>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div id="form-nav" class="listbiaoti am-cf">
            ...
            <form class="am-form am-g" encType="multipart/form-data">
